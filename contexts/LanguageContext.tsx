...
const translations: { [lang in Language]: { [key: string]: string } } = {
    en: {
        ...
        aiAnalysisDisclaimer: 'Here is an analysis based on the symptoms you provided. Please remember, this is not a medical diagnosis.',
        ...
        symptomAnalyzerDescription: 'Describe your symptoms, and our AI will provide potential causes and suggestions. This is not a substitute for professional medical advice.',
        ...
        profileInfo: "This information helps in personalizing your plans. It's stored only on your device.",
        ageLabel: "Age",
        ...
        usingLatestHealthData: "Using latest health data (Age: {age}, BMI: {bmi}) for personalization.",
        noHealthDataForExercise: "Add health data in the 'Tracker' tab for a personalized plan.",
        ...
        noHealthDataError: 'Health data is required to generate an exercise plan. Please add an entry in the Tracker tab.',
        ...
        selectGoalsForExercise: 'Select your goals and generate a new exercise plan.',
        walletTitle: 'Health Wallet',
        walletDescription: 'Securely store your medical records, prescriptions, and insurance details. All data is saved only on your device.',
        add: 'Add',
        edit: 'Edit',
        ...
        save: 'Save',
        confirmClearData: 'Are you sure you want to clear all app data? This action cannot be undone.',
        ...
        notificationsBlocked: 'Notification permission is blocked in your browser settings.',
        ...
        inspirationText: "In many countries, patient records are scattered or paper-based, and people often don’t know what benefits or drugs they’re entitled to. This leads to huge delays in treatment and inefficient care. We saw an opportunity to change that.",
        storyTitle: "Our Story & Solution",
        storyText: "Born from a desire to bridge this gap, পরামর্শক AI started as a secure, mobile-first health identity. Our solution aggregates records, prescriptions, insurance, and telehealth into one simple, private wallet, empowering users to take control of their health information.",
        whatAppOffersTitle: "What This App Offers",
        whatAppOffersText: "A comprehensive suite of tools to manage your well-being:\n• AI Symptom Analyzer: Get instant, AI-powered insights on your health concerns.\n• Health Tracker: Log your vitals, track your progress with beautiful charts, and get personalized advice.\n• Diet & Exercise Planners: Receive custom 7-day plans tailored to your specific goals and health data.\n• Health Wallet: Securely store all your medical documents, prescriptions, and insurance info in one place, on your device.",
        teamTitle: "Meet the Team",
        teamText: "Developed with passion by Team Last Minute. We are dedicated to building accessible, user-centric technology that makes a real-world impact on people's health and lives.",
    },
    bn: {
        ...
        aiAnalysisDisclaimer: 'আপনার দেওয়া লক্ষণগুলির উপর ভিত্তি করে এখানে একটি বিশ্লেষণ দেওয়া হলো। দয়া করে মনে রাখবেন, এটি কোনও ডাক্তারি تشخیص নয়।',
        unknownError: 'একটি অজানা ত্রুটি ঘটেছে।',
        aiProcessError: 'দুঃখিত, আপনার অনুরোধ প্রক্রিয়া করার সময় একটি ত্রুটি ঘটেছে:',
        downloadChat: 'চ্যাট ডাউনলোড করুন',
        downloading: 'ডাউনলোড হচ্ছে...',
        symptomAnalyzerTitle: 'এআই বিশ্লেষক',
        conversation: 'কথোপকথন',
        symptomAnalyzerDescription: 'আপনার লক্ষণগুলি বর্ণনা করুন, এবং আমাদের এআই সম্ভাব্য কারণ এবং পরামর্শ দেবে। এটি পেশাদার চিকিৎসা পরামর্শের বিকল্প নয়।',
        ...
        profileInfo: "এই তথ্য আপনার পরিকল্পনা ব্যক্তিগতকরণে সহায়তা করে। এটি শুধুমাত্র আপনার ডিভাইসে সংরক্ষিত থাকে।",
        ageLabel: "বয়স",
        ...
        addEntryForAdvice: "ব্যক্তিগতকৃত এআই পরামর্শ পেতে একটি স্বাস্থ্য এন্ট্রি যোগ করুন।",
        ...
        usingLatestHealthData: "ব্যক্তিগতকরণের জন্য সর্বশেষ স্বাস্থ্য ডেটা (বয়স: {age}, BMI: {bmi}) ব্যবহার করা হচ্ছে।",
        noHealthDataForExercise: "একটি ব্যক্তিগতকৃত পরিকল্পনার জন্য 'ট্র্যাকার' ট্যাবে স্বাস্থ্য ডেটা যোগ করুন।",
        ...
        selectGoalsForDiet: "আপনার লক্ষ্য নির্বাচন করুন এবং একটি নতুন ডায়েট প্ল্যান তৈরি করুন।",
        ...
        time45min: '৪৫ মিনিট',
        time60min: '৬০ মিনিট',
        noHealthDataError: 'ব্যায়াম পরিকল্পনা তৈরির জন্য স্বাস্থ্য ডেটা প্রয়োজন। দয়া করে ট্র্যাকার ট্যাবে একটি এন্ট্রি যোগ করুন।',
        ...
        selectGoalsForExercise: 'আপনার লক্ষ্য নির্বাচন করুন এবং একটি নতুন ব্যায়াম পরিকল্পনা তৈরি করুন।',
        walletTitle: 'হেলথ ওয়ালেট',
        walletDescription: 'আপনার মেডিকেল রেকর্ড, প্রেসক্রিপশন এবং বীমার বিবরণ নিরাপদে সংরক্ষণ করুন। সমস্ত ডেটা শুধুমাত্র আপনার ডিভাইসে সংরক্ষিত থাকে।',
        add: 'যোগ করুন',
        edit: 'সম্পাদনা',
        ...
        save: 'সংরক্ষণ করুন',
        confirmClearData: 'আপনি কি সমস্ত অ্যাপ ডেটা মুছে ফেলতে নিশ্চিত? এই কাজটি পূর্বাবস্থায় ফেরানো যাবে না।',
        confirmLogout: 'আপনি কি লগ আউট করতে নিশ্চিত?',
        clearAllData: 'অ্যাপ ডেটা সাফ করুন',
        dataManagement: 'ডেটা ম্যানেজমেন্ট',
        dataManagementDesc: 'আপনার ব্রাউজারে এই অ্যাপ দ্বারা সংরক্ষিত ডেটা পরিচালনা করুন।',
        login: 'লগ ইন করুন',
        logout: 'লগ আউট করুন',
        account: 'অ্যাকাউন্ট',
        ...
        downloadAllDataDesc: 'আপনার সমস্ত অ্যাপ ডেটা একটি JSON ফাইল হিসাবে ডাউনলোড করুন।',
        ...
        notificationsBlocked: 'আপনার ব্রাউজার সেটিংসে নোটিফিকেশন অনুমতি ব্লক করা আছে।',
        ...
        inspirationText: "অনেক দেশে রোগীর রেকর্ডগুলি বিক্ষিপ্ত বা কাগজ-ভিত্তিক, এবং মানুষ প্রায়ই জানে না যে তারা কোন সুবিধা বা ওষুধের অধিকারী। এর ফলে চিকিৎসায় ব্যাপক বিলম্ব হয় এবং যত্ন অদক্ষ হয়ে পড়ে। আমরা এটি পরিবর্তন করার একটি সুযোগ দেখেছি।",
        storyTitle: "আমাদের গল্প এবং সমাধান",
        storyText: "এই ব্যবধান দূর করার ইচ্ছা থেকে জন্ম নেওয়া, পরামর্শক AI একটি সুরক্ষিত, মোবাইল-প্রথম স্বাস্থ্য পরিচয় হিসাবে শুরু হয়েছিল। আমাদের সমাধান রেকর্ড, প্রেসক্রিপশন, বীমা এবং টেলিহেলথকে একটি সহজ, ব্যক্তিগত ওয়ালেটে একত্রিত করে, ব্যবহারকারীদের তাদের স্বাস্থ্য তথ্যের নিয়ন্ত্রণ নিতে সক্ষম করে।",
        whatAppOffersTitle: "এই অ্যাপটি কী অফার করে",
        whatAppOffersText: "আপনার সুস্থতা পরিচালনা করার জন্য একটি جامع স্যুট:\n• এআই বিশ্লেষক: আপনার স্বাস্থ্য উদ্বেগ সম্পর্কে তাত্ক্ষণিক, এআই-চালিত অন্তর্দৃষ্টি পান।\n• স্বাস্থ্য ট্র্যাকার: আপনার অত্যাবশ্যকীয় বিষয়গুলি লগ করুন, সুন্দর চার্ট দিয়ে আপনার অগ্রগতি ট্র্যাক করুন এবং ব্যক্তিগতকৃত পরামর্শ পান।\n• ডায়েট এবং ব্যায়াম পরিকল্পনাকারী: আপনার নির্দিষ্ট লক্ষ্য এবং স্বাস্থ্য ডেটার জন্য কাস্টম ৭-দিনের পরিকল্পনা গ্রহণ করুন।\n• স্বাস্থ্য ওয়ালেট: আপনার সমস্ত মেডিকেল নথি, প্রেসক্রিপশন এবং বীমা তথ্য এক জায়গায়, আপনার ডিভাইসে নিরাপদে সংরক্ষণ করুন।",
        teamTitle: "টিমের সাথে দেখা করুন",
        teamText: "টিম লাস্ট মিনিট দ্বারা আবেগের সাথে বিকশিত। আমরা অ্যাক্সেসযোগ্য, ব্যবহারকারী-কেন্দ্রিক প্রযুক্তি তৈরিতে নিবেদিত যা মানুষের স্বাস্থ্য এবং জীবনে একটি বাস্তব-বিশ্বের প্রভাব ফেলে।",
    },
};
...
export const LanguageProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    const [language, setLanguage] = useState<Language>(() => {
        const storedLang = typeof window !== 'undefined' ? localStorage.getItem('language') as Language | null : 'en';
