            ...
            <div className="relative pt-10 pb-4">
                <div className="absolute top-0 transition-all duration-300 ease-out" style={{ left: `${percentage}%`, transform: 'translateX(-50%)' }}>
                     <div className="relative flex flex-col items-center">
                        <span className="px-2 py-0.5 rounded-md bg-zinc-800 dark:bg-zinc-200 text-white dark:text-black text-sm font-bold shadow-md">{bmi.toFixed(1)}</span>
        ...
        <div className="space-y-6 animate-fade-in-up">
            <div className="bg-white dark:bg-zinc-900 p-4 sm:p-6 rounded-xl border border-gray-200/80 dark:border-zinc-800/80 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                 ...
                 <div>
                    ...
                    <input type="number" id="age" value={age} onChange={handleAgeChange} className="block w-full rounded-md border-gray-300 dark:border-zinc-700 shadow-sm focus:border-teal-500 focus:ring-teal-500 sm:text-sm p-2.5 bg-gray-50 dark:bg-zinc-800" placeholder={t('agePlaceholder')} required />
                 </div>
            </div>
            ...
            <div className="bg-white dark:bg-zinc-900 p-4 sm:p-6 rounded-xl border border-gray-200/80 dark:border-zinc-800/80 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                ...
                <form onSubmit={handleAddEntry} className="space-y-4">
                    <div>
                        ...
                        <input type="number" step="0.1" id="weight" value={weight} onChange={e => setWeight(e.target.value)} className="block w-full rounded-md border-gray-300 dark:border-zinc-700 shadow-sm focus:border-teal-500 focus:ring-teal-500 sm:text-sm p-2.5 bg-gray-50 dark:bg-zinc-800" placeholder={t('weightPlaceholder')} required />
                    </div>
                    <div>
                        ...
                        {heightUnit === 'cm' ? (
                             <input type="number" step="0.1" id="height" value={height} onChange={handleHeightCmChange} className="block w-full rounded-md border-gray-300 dark:border-zinc-700 shadow-sm focus:border-teal-500 focus:ring-teal-500 sm:text-sm p-2.5 bg-gray-50 dark:bg-zinc-800" placeholder={t('heightPlaceholder') + ' (cm)'} required />
                        ) : (
                            <div className="flex items-center space-x-2">
                                <input type="number" value={feet} onChange={e => setFeet(e.target.value)} className="block w-full rounded-md border-gray-300 dark:border-zinc-700 shadow-sm focus:border-teal-500 focus:ring-teal-500 sm:text-sm p-2.5 bg-gray-50 dark:bg-zinc-800" placeholder={t('feetPlaceholder')} aria-label="feet" />
                                <input type="number" step="0.1" value={inches} onChange={e => setInches(e.target.value)} className="block w-full rounded-md border-gray-300 dark:border-zinc-700 shadow-sm focus:border-teal-500 focus:ring-teal-500 sm:text-sm p-2.5 bg-gray-50 dark:bg-zinc-800" placeholder={t('inchesPlaceholder')} aria-label="inches" />
                            </div>
                        )}
                    </div>
            ...
            <div ref={downloadAreaRef} className="space-y-6 bg-gray-100 dark:bg-zinc-950 p-4">
                        ...
                        <div className="h-72">
                            <ResponsiveContainer width="100%" height="100%">
                                <LineChart data={history} margin={{ top: 5, right: 10, left: -10, bottom: 5 }}>
                                    ...
                                    <Tooltip contentStyle={{backgroundColor: theme === 'dark' ? '#18181b' : '#ffffff', border: '1px solid #e5e7eb', borderRadius: '0.5rem'}}/>
