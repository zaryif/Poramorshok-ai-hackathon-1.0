...
const Header = React.forwardRef<HTMLHeadElement, HeaderProps>(({ activeView, setActiveView, isScrolled, scrollDirection }, ref) => {
  ...
  return (
    ...
    >
      <div className={`pt-4 transition-all duration-300 ${isScrolled ? 'bg-gray-100/80 dark:bg-zinc-950/80 backdrop-blur-md border-b border-gray-200/80 dark:border-zinc-800/80' : 'bg-transparent'}`}>
        <div className="max-w-7xl mx-auto px-4">
          <div className={`flex items-center justify-between transition-all duration-300 ${isScrolled ? 'h-14' : 'h-28'}`}>
            ...
            <div className="flex items-center gap-2 min-w-0">
              ...
              <h1 className={`font-bold text-gray-800 dark:text-gray-200 truncate transition-all duration-300 ${isScrolled ? 'text-lg' : 'text-xl'}`}>পরামর্শক AI</h1>
            </div>
